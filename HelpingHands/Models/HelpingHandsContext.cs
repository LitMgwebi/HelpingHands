...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=Lithi_Mgwebi\\SQLEXPRESS;Initial Catalog=HelpingHands;Integrated Security=True;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Nurse>(entity =>
        {
            ...
            entity.HasMany(d => d.Suburbs).WithMany(p => p.Nurses)
                .UsingEntity<Dictionary<string, object>>(
                    "PrefferedSuburb",
                    r => r.HasOne<Suburb>().WithMany()
                        .HasForeignKey("SuburbId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_PrefferedSuburb_Suburb"),
                    l => l.HasOne<Nurse>().WithMany()
                        .HasForeignKey("NurseId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_PrefferedSuburb_Nurse"),
                    j =>
                    {
                        j.HasKey("NurseId", "SuburbId");
                        j.ToTable("PrefferedSuburb");
                    });
        });
        ...
        modelBuilder.Entity<Patient>(entity =>
        {
            ...
            entity.HasMany(d => d.Conditions).WithMany(p => p.Patients)
                .UsingEntity<Dictionary<string, object>>(
                    "PatientCondition",
                    r => r.HasOne<Condition>().WithMany()
                    ...
                    j =>
                    {
                        j.HasKey("PatientId", "ConditionId");
                        j.ToTable("PatientCondition");
                    });
        });
